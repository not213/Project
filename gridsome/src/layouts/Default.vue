  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/"><g-image src="../../static/213.jpg" class="w-10" alt="logo" /></g-link>
          <g-link v-else to="/"><g-image src="../../static/213.jpg" class="w-10" alt="logo" /></g-link>
        </div>
        ...
        >
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/#projects" v-scroll-to="'#projects'" class="text-copy-primary hover:text-gray-600">หน้าแรก</a>
            <g-link v-else to="/#projects" class="text-copy-primary hover:text-gray-600">หน้าแรก</g-link>
          </li>
          
          
          <li class="mr-8 mb-6 lg:mb-0">
            <g-link to="/docs" class="text-copy-primary hover:text-gray-600">กิจกรรมต่างๆ</g-link>
          </li>
          <li>
            <g-link to="/blog" class="text-copy-primary hover:text-gray-600">ข้อมูลโครงการ อพ.สธ</g-link>
          </li>
        </ul>
      </nav>
    </header>
